...
class FormacaoPrevista(models.Model):
    ...
    datainicial = models.DateField(max_length=255)
    datafinal = models.DateField(max_length=255)
...
class MembroFormacao(models.Model):
    ...
    formacao_prevista = models.ForeignKey(FormacaoPrevista, on_delete=models.CASCADE, related_name='c_formacaoid_membroid')
