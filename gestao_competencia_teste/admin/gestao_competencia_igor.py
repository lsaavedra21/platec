...
from ..models import Membro, Setor, Cargo, Tecnologia, Formacao, Competencia, ConsultaCompetencia, ConsultaFormacao, FormacaoPrevista
...
class FormacaoPrevistaAdmin(admin.ModelAdmin):
    list_display = ('formacao', 'formador', 'duracao', 'vagas', 'data')
    list_filter = ('formacao', 'data')
    search_fields = ('formacao__nome','data')
